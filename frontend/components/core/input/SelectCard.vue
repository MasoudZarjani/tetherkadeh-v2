  ...
  <Listbox class="w-full mt-6">
    <div class="relative mt-1">
      ...
      >
        ...
        <span class="truncate flex justify-start items-center" v-if="modelValue"
          >{{ $t('bank.title') }} {{ $t('bank.' + modelValue?.name?.toLowerCase()) }}
          -
          {{ modelValue?.cardNumber }}
        </span>
        <span class="truncate flex justify-start items-center" v-else>
          {{ $t('noCard') }}
        </span>
      </ListboxButton>
      <transition
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                {{ $t('bank.' + card?.name.toLowerCase()) + ' - ' + card?.cardNumber }}
              </span>
              <span
                v-if="selected"
          ...
          <ListboxOption v-slot="{ selected }" @click="addNewCard()" as="template" class="mt-2">
            <li class="relative cursor-pointer select-none py-4 pl-10 pr-4">
              <span
