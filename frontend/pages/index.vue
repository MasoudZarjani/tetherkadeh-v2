...
<template>
  <CoreDialogAnnouncement v-if="locale === 'fa'">
    ...
    <p class="my-2">کلاهبردار وجعلی میباشد و هیچ گونه ارتباطی به مجموعه ما ندارد.</p>
    <p class="my-2">
      سایت اصلی تترکده فقط به این نام و نشانی میباشد هیچ کلمه یا حرف اضافه ای ندارد
    </p>
    <p class="my-2">✅ tetherkade.com ✅</p>
    <p class="my-2">
